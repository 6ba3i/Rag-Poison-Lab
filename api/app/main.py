...
from api.app.routers import experiments, health, recs, results, settings_attack, settings_defense, settings_llm, trace, users
...
app.include_router(settings_defense.router, prefix="/api")
