...
class QwenProvider(LlmProvider):
    ...
    def generate(
        ...
        *,
        ...
        if api_key is None:
            raise RuntimeError("Qwen provider is unavailable: missing API key (env or secret file)")
        raise NotImplementedError("Qwen provider generate() is not implemented in MVP task 08")
