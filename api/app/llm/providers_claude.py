...
class ClaudeProvider(LlmProvider):
    ...
    def __init__(
        ...
        *,
        ...
        self.base_url = (base_url or "https://api.anthropic.com/v1").strip() or "https://api.anthropic.com/v1"
    ...
    def generate(
        ...
        *,
        ...
        client = AnthropicClient(base_url=self.base_url, api_key=api_key, timeout=self.timeout)
