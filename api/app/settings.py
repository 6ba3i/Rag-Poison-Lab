...
class Settings(BaseSettings):
    ...
    cloud_llm_timeout_seconds: float = Field(default=90.0, gt=0)
    cloud_llm_max_retries: int = Field(default=2, ge=0, le=5)
    cloud_llm_retry_backoff_seconds: float = Field(default=1.0, ge=0)
