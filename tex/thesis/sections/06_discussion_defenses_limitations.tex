...
the second option to consider would be the penalizing suspected poisoned document by giving them a low retrieval score, it would be very effective but raises a very high risk of false positives that could itself endanger the recommendation pipeline \cite{jia2023pore,nguyen2024manipulatingrecsys,wang2024recpoisonsurvey}. 
