...
\noindent\textit{\footnotesize Code excerpt: Poisoned bulk construction.}\par\vspace{0.2em}\begin{minted}{python}
...
\noindent\textit{\footnotesize Code excerpt: Poisoned JSONL bulk action.}\par\vspace{0.2em}\begin{minted}{python}
...
\noindent\textit{\footnotesize Code excerpt: Targeted promotion marker and boost.}\par\vspace{0.2em}
\begin{minted}{python}
...
\noindent\textit{\footnotesize Code excerpt: Prompt injection payload and target synopsis suffix.}\par\vspace{0.2em}
\begin{minted}{python}
...
\noindent\textit{\footnotesize Code excerpt: Untargeted degradation field mutation.}\par\vspace{0.2em}\begin{minted}{python}
doc["genres"] = genres
...
\noindent\textit{\footnotesize Code excerpt: Poisoned index alias switch.}\par\vspace{0.2em}\begin{minted}{python}
