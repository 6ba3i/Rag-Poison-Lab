...
The main source of control is that all runs are made on the same starter data and top-$k$ values and that all steps are recorded. Retrieval and ranking have modular parameters from retrieval method and its three modes (lexical, dense or hybrid) to ranking modes (deterministic or LLM based). All behavior can be audited and allows deep knowledge of every-step knowing what happened and how to reproduce it \cite{ragpoisonlab_repo}. 
